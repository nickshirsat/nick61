...
def positive():
    messagebox.showinfo(title="Prediction", message="Diabetes is Positive(Detected)")
    root.quit()


def negative():
    messagebox.showinfo(title="Prediction", message="Diabetes is Negative(Not Detected)")
    root.quit()
